import { QueryClient, QueryClientProvider, useQuery, UseQueryOptions, QueryKey, QueryFunction, useMutation, useInfiniteQuery } from 'react-query';
...
export type CreateUseInfinityQueryProps<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey> = {
  key: ((...args: any[]) => QueryKey) | QueryKey;
  fn: ((...args: any[]) => QueryFunction) | QueryFunction;
  options?: Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryFnData, TQueryKey>, 'queryKey'>;
};

export type UseInfinityQueryProps<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey> = {
  key?: any;
  fn?: any;
  options?: Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryFnData, TQueryKey>, 'queryKey'>;
};
...
export const createUseInfinityQueries = (params: CreateUseInfinityQueryProps[]) =>
  params.map(param => {
    return <TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryKey extends QueryKey = QueryKey>(props?: UseInfinityQueryProps) => {
      if (!props) props = {};
      ...
      const queryOptions = {
        ...(param.options || {}),
        ...(props.options || {}),
      } as Omit<UseInfiniteQueryOptions<TQueryFnData, TError, TData, TQueryFnData, TQueryKey>, 'queryKey'>;

      return useInfiniteQuery<TQueryFnData, TError, TData, TQueryKey>(queryKey, queryFn, queryOptions);
    };
  });
